...
client_id = "ld62nRKAfZL7Amf9b6AZ"
client_secret = "MkMxOb1ESG"
...
for gu in seoul_gu:
    ...
    keyword = f'{gu} 속눈썹'
    # 맛집 리스트를 받아옵니다.
    eyelashes_list = get_naver_result(keyword)

    # 구별 맛집 구분선입니다.
    print("*"*80 + gu)

    for eyelashes in eyelashes_list:
        # 구 정보를 추가합니다.
        eyelashes['gu'] = gu
        # 맛집을 인쇄합니다.
        pprint.pprint(eyelashes)
        # docs에 맛집을 추가합니다.
        docs.append(eyelashes)

# 맛집 정보를 저장합니다.
db.eyelashes.insert_many(docs)
